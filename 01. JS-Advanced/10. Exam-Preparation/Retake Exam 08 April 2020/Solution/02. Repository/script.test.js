...
describe("Repository", function () {
    ...
    describe("update", function () {
        it("update throw error if entity with invalid params is passed", function () {
            ...
            assert.throw(() => { repo.update(0, gosho) });

            assert.throw(() => { repo.update(0, tosho) });
        });
        ...
        it("update throw error if Id not exist", function () {
            ...
            assert.throw(() => { repo.update(0, pesho) });

            assert.throw(() => { repo.update(1, pesho) });
